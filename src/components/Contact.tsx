...
const Contact = () => {
  ...
  return (
    <section id="kontakt" className="py-24 relative" ref={ref}>
      <div className="container relative z-10 px-4">
        <div className="max-w-2xl mx-auto text-center">
          ...
          {/* Contact options */}
          <div 
            className={`flex flex-col sm:flex-row gap-4 justify-center mb-12 ${isVisible ? "animate-scale-up" : "opacity-0"}`}
          ...
          {/* Email display */}
          <div 
            className={`inline-flex items-center gap-3 px-6 py-4 rounded-xl border border-border bg-card/50 backdrop-blur-sm ${
