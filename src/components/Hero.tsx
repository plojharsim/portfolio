    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden py-10 md:py-0">
      ...
      <div className="container relative z-10 px-4 pt-12 md:pt-0">
        <div className="max-w-4xl mx-auto text-center">
          ...
          {/* Subtitle / Main Pitch */}
          <h2 className="text-xl md:text-3xl font-bold text-foreground max-w-3xl mx-auto mb-4 animate-fade-in leading-relaxed" style={{ animationDelay: "0.2s" }}>
            Pomáhám lidem a malým firmám řešit digitální problémy.
          </h2>

          {/* Description */}
          <p className="text-base md:text-xl text-primary/90 font-medium max-w-2xl mx-auto mb-8 md:mb-10 animate-fade-in" style={{ animationDelay: "0.3s" }}>
