import { Github, Mail, ArrowDown, Youtube, Sparkles } from "lucide-react";
      ...
      <div className="container relative z-10 px-4 pt-12 md:pt-0">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-primary/30 bg-primary/5 mb-4 md:mb-8 animate-fade-in">
            ...
            <span className="text-sm font-mono text-primary">Digitální řešení na míru</span>
          </div>

          {/* Name */}
          <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold mb-4 md:mb-6 animate-fade-in leading-tight" style={{ animationDelay: "0.1s" }}>
            Pomáhám lidem a malým firmám <span className="text-gradient">řešit digitální problémy.</span>
          </h1>

          {/* Subtitle */}
          <p className="text-lg md:text-2xl text-foreground/90 font-medium max-w-3xl mx-auto mb-6 md:mb-10 animate-fade-in" style={{ animationDelay: "0.2s" }}>
            Weby, automatizace, vlastní nástroje, AI a další řešení na míru.
          </p>

          <p className="text-sm md:text-base text-muted-foreground max-w-xl mx-auto mb-8 animate-fade-in font-mono" style={{ animationDelay: "0.3s" }}>
          ...
          {/* Social links */}
          <div className="flex justify-center gap-4 mt-8 md:mt-12 animate-fade-in" style={{ animationDelay: "0.5s" }}>
            <a
