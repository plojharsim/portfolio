...
import { ExternalLink, Github, Layout, GraduationCap, Home, Gift, Server, ArrowRight } from "lucide-react";
...
const ProjectsPage = () => {
  ...
  const projectIcons: Record<string, React.ComponentType<{ className?: string }>> = {
    ...
    "Seply": Layout,
    "Veselé Vánoce": Gift,
    "Homelab & Network Infrastructure": Server,
  };
      ...
      <section className="pt-32 pb-16 px-4">
        <div className="container max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Kompletní seznam mých prací, od webových aplikací až po síťovou infrastrukturu.
          </p>
        </div>
      </section>
        ...
        <div className="container max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {projects.map((project, index) => {
              ...
              const hasDetail = !!(project.fullDescription || project.images || project.features);
              ...
              return (
                ...
                >
                  ...
                  <div className="flex flex-col gap-4">
                    ...
                    {hasDetail && (
                      <Button variant="ghost" size="sm" asChild className="w-full mt-2 justify-between hover:bg-primary/5 group-hover:text-primary">
