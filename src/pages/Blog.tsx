      ...
      <section className="py-16 px-4">
        <div className="container max-w-4xl mx-auto">
          {blogPosts.length > 0 ? (
            ...
            <div className="flex flex-col items-center justify-center py-20 px-6 rounded-3xl border border-dashed border-border bg-card/30 text-center">
              <div className="w-20 h-20 rounded-full bg-primary/5 flex items-center justify-center mb-8">
                <MessageSquareOff className="h-10 w-10 text-primary/40" />
              </div>
              <h2 className="text-2xl font-bold mb-4">Blog je zatím prázdný</h2>
              <p className="text-muted-foreground max-w-md text-lg">
                Pracuji na zajímavých tématech, o kterých bych chtěl psát. Brzy se tu objeví první příspěvky!
              </p>
            </div>
          )}
        </div>
